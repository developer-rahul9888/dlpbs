                                                ...
                                                <div class="form">
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        <label for="validationCustom02"
                                                            class="col-xl-3 col-sm-4 mb-0">Balance:</label>
                                                        <div class="col-xl-8 col-sm-7">
                                                            <input class="form-control" readonly  value="{{auth()->user()->credit}}"
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="col-xl-8 col-sm-7">
                                                            <input class="form-control"  id="redeem" name="amount" value="{{old('amount')}}"
                                                                type="number" required="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        <label for="validationCustom01"
                                                            class="col-xl-3 col-sm-4 mb-0">After deduction :</label>
                                                        <div class="col-xl-8 col-sm-7">
                                                            <input class="form-control" id="balance" name="balance" value="{{old('balance')}}"
                                                                type="text" required="">
                                                        </div>
                                                    </div>
                        ...
                        <div class="card-body">
                            <table class="display" id="basic-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        <td>INR {{$value->redeem}}</td>
                                        <td>INR {{$value->after_tds}}</td>
                                        <td>{{$value->redeem_status}}</td>
...
<script>
    ...
    jQuery('#redeem').keyup(function(){
        ...
        jQuery("#balance").val(parseFloat(redeem*0.90));
    });
</script>
@endsection
