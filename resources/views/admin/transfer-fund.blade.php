                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <h3>Transfer Fund
                                        <small>Transfer fund to Activation wallet</small>
                                    </h3>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                                ...
                                                <div class="form">
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        <label for="validationCustom02"
                                                            class="col-xl-3 col-sm-4 mb-0">Current Balance</label>
                                                        <div class="col-xl-8 col-sm-7">
                                                            <input class="form-control" readonly name="balance" value="{{auth()->user()->credit}}"
